...
createActivitiesFor = (name) ->
	...
	if (name == 'ajla')
		for event of ala
			activity = instantiateItemFor(ala[event.toString()])
			activities.push(activity)
	else if (name == 'daniel')
		for event of dalan
			activity = instantiateItemFor(dalan[event.toString()])
			print activity
			activities.push(activity)
	else if (name == 'matilda')
		for event of matalda
			activity = instantiateItemFor(matalda[event.toString()])
			activities.push(activity)
	else if (name == 'mattias')
		for event of maitas
			activity = instantiateItemFor(maitas[event.toString()])
			activities.push(activity)
	else if (name == 'paul')
		for event of pol
			activity = instantiateItemFor(pol[event.toString()])
			activities.push(activity)
	
	for activity in activities
		instantiateItemFor(activity)
